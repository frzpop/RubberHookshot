...
public class InputManager : MonoBehaviour {
	...
	void Start ()
	{
		if (Application.platform == RuntimePlatform.Android)
			onMobile = true;
		cam = Camera.main;
		playerClass = player.GetComponent<Player2D>();
	}
	...
	{
		ResetAnchor();
		playerClass.anchored = true;
		playerClass.anchorPos = anchorPosition;
	}
	public void UnAnchor()
	{
		ResetAnchor();
		if ( playerClass.anchored )
		{
			playerClass.anchored = false;
		}
	}
	void ResetAnchor ()
	{
